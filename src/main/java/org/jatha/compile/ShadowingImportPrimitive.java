 ...
 */
/**
 * $Id: ShadowingImportPrimitive.java,v 1.1 2005/05/22 20:15:53 olagus Exp $
 */
...
/**
 * <p>This is like import, but it does not signal an error if the import would shadow some symbol in the package.</p>
 * <p>(shadowing-import symbols &optional package)</p>
 ...
 */
public class ShadowingImportPrimitive extends LispPrimitive {
    private LambdaList args;

    private LispValue symbolsSym;
    private LispValue packageSym;

    public ShadowingImportPrimitive(final Jatha lisp) {
        super(lisp, "SHADOWING-IMPORT", 1, 2);
    ...
    public void Execute(final SECDMachine machine) {
  	...
  	final LispValue pkg = (LispValue)arguments.get(packageSym);
        ...
        machine.S.push(((StandardLispPackage)pack).shadowing_import(symb));
        machine.C.pop();
    }
