...
{
  public GethashPrimitive(Jatha lisp)
  {
    super(lisp, "GETHASH", 2, 3);
  }

  public void Execute(SECDMachine machine)
  {
  	LispValue args = machine.S.pop();
  	LispValue ht   = args.second();

  	if (args.basic_length() == 2)
	    machine.S.push(ht.gethash(args.first(), args.third()));
	  else
	    machine.S.push(ht.gethash(args.first()));
