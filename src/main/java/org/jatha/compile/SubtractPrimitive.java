...
public class SubtractPrimitive extends LispPrimitive
{
  public SubtractPrimitive(Jatha lisp)
  {
    super(lisp, "-", 1, Long.MAX_VALUE);
  }
  ...
  public void Execute(SECDMachine machine)
  {
    ...
    machine.S.push(args.car().subtract(args.cdr()));
    machine.C.pop();
  }
