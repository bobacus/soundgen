 ...
 */
/**
 * $Id: ImportPrimitive.java,v 1.1 2005/05/22 20:15:53 olagus Exp $
 */
...
/**
 * <p>Imports symbols into a package, which means that you can refer to the symbols within the package without colon-syntax</p>
 * <p>(import symbols &optional package)</p>
 ...
 */
public class ImportPrimitive extends LispPrimitive {
    private LambdaList args;

    private LispValue symbolsSym;
    private LispValue packageSym;

    public ImportPrimitive(final Jatha lisp) {
        super(lisp, "IMPORT", 1, 2);
    ...
    public void Execute(final SECDMachine machine) {
  	...
  	final LispValue pkg = (LispValue)arguments.get(packageSym);
        ...
        machine.S.push(((StandardLispPackage)pack).lisp_import(symb));
        machine.C.pop();
    }
