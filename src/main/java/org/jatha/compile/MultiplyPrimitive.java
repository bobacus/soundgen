...
public class MultiplyPrimitive extends LispPrimitive
{
  public MultiplyPrimitive(Jatha lisp)
  {
    super(lisp, "*", 0, Long.MAX_VALUE);
  }
  ...
  public void Execute(SECDMachine machine)
  {
    ...
    if (args == f_lisp.NIL)
      machine.S.push(f_lisp.ONE);
    else
      machine.S.push(args.car().multiply(args.cdr()));
    machine.C.pop();
  }
