...
/**
 * <p>Sets the documentation for the symbol specified.</p>
 * <p>(setf-documentation symbol type string)</p>
 ...
 */
public class SetfDocumentationPrimitive extends LispPrimitive {
    public SetfDocumentationPrimitive(final Jatha lisp) {
        super(lisp, "SETF-DOCUMENTATION", 3, 3);
    }
    ...
    public void Execute(final SECDMachine machine) {
        ...
        machine.S.push(sym.setf_documentation(type,val));
        machine.C.pop();
    }
