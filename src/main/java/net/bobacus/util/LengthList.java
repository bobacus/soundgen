...
public class LengthList {
     ...
     * If the list doesn't contain enough dots (i.e. n >= length of list), the index of the final length is returned.
     * If there are no lengths, then -1 is returned.
     *
     * @param position n
    ...
    /**
     * Calculates the offset of the given position from the start of its length, or if it is "off the end", then the
     * distance from the end of the overall length.
     *
